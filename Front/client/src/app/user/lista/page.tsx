...
import { useHouseTypes } from "@/contexts/HouseTypesContext"; // ✅ Importar o contexto de tipos
...
export default function Page() {
  ...
  const { types } = useHouseTypes(); // ✅ Usar tipos

  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-100 w-full py-12">
